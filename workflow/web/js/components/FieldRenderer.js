(function () {
  ...
  window.VueComponents.FieldRenderer = {
    ...
    template: [
      ...
      '    <span v-if="labelMarker === \'auto_set\'" class="auto-set" :title="t(\'fieldRenderer.autoSet\')">⚡</span>',
      ...
      '    :value="currentValue"',
      '    @input="$emit(\'update:modelValue\', $event.target.value)"',
      '    :placeholder="field.help || t(\'fieldRenderer.path\')" />',
      ...
      '      <option value="">{{ t(\'fieldRenderer.noUpstreamCheckpoint\') }}</option>',
      ...
      '      :value="currentValue"',
      '      @input="$emit(\'update:modelValue\', $event.target.value)"',
      '      :placeholder="t(\'fieldRenderer.noUpstreamTrain\')" />',
      ...
      '        {{ bucketStatsLoading ? t(\'fieldRenderer.analyzing\') : t(\'fieldRenderer.analyzeDataset\') }}',
      '      </button>',
      '    </div>',
      ...
      '          {{ t(\'fieldRenderer.resized\', {n: bucketStats.families[opt].resized}) }}',
      '        </span>',
      '      </div>',
      '    </div>',
      '  </div>',
