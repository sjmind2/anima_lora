...
STRINGS: dict[str, str] = {
    ...
    "browse": "参照…",
    # LyCORIS
    "tucker_decomposition": "タッカー分解",
    "kronecker_factor": "クロネッカー因子",
    "hadamard_product": "アダマール積",
    "low_rank_hadamard_product": "低ランク アダマール積",
    "low_rank_kronecker_product": "低ランク クロネッカー積",
    "tucker_core_tensor": "タッカーコアテンソル",
    "factorization": "因数分解",
    "decompose_both": "両方を分解",
    "use_tucker": "タッカー分解を使用",
    "lokr_factor": "LOKR 因子",
    "conv_dim": "畳み込み次元",
    "conv_alpha": "畳み込み alpha",
    "scale_weight_norms": "重みノルムスケーリング",
