...
STRINGS: dict[str, str] = {
    ...
    "browse": "Browse…",
    # LyCORIS
    "tucker_decomposition": "Tucker Decomposition",
    "kronecker_factor": "Kronecker Factor",
    "hadamard_product": "Hadamard Product",
    "low_rank_hadamard_product": "Low-Rank Hadamard Product",
    "low_rank_kronecker_product": "Low-Rank Kronecker Product",
    "tucker_core_tensor": "Tucker Core Tensor",
    "factorization": "Factorization",
    "decompose_both": "Decompose Both",
    "use_tucker": "Use Tucker Decomposition",
    "lokr_factor": "LOKR Factor",
    "conv_dim": "Conv Dimension",
